...
export function RevenueChartSkeleton() {
  return (
    ...
    >
      <div className="h-7 w-36 rounded-md bg-gray-100 md:h-8" />
      <div className="rounded-xl bg-gray-100 p-4">
        <div className="h-[406px] rounded-md bg-white" />
  ...
  return (
    <>
      <div
        className={clsx(
          shimmer,
          'relative mb-4 h-7 w-36 overflow-hidden rounded-md bg-gray-100 md:h-8',
        )}
      />
